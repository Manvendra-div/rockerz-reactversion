...
const ShareCard = ({ toggleFunc, pushNoti, addContentNoti, cardState }) => {
  const shareData = `
🎵 Explore Rockerz WEB
...
`;
  ...
  return (
    <Transition
      ...
      leaveTo="opacity-0"
      className="fixed z-40 h-screen w-screen flex justify-center items-center bg-black bg-opacity-40"
    >
      <Transition.Child
        className="w-[90%] md:w-[50%] bg-[#3a3a3b] rounded-xl p-3 border border-gray-300 shadow-2xl flex flex-col justify-center items-center"
